...
export const getAllReservaHabitaciones = async (_req: Request, res: Response, next: NextFunction) => {
  try {
    const reservas = await reservaHabitacionService.getAllReservaHabitaciones();
...
export const getReservaHabitacionById = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const reserva = await reservaHabitacionService.getReservaHabitacionById(Number(req.params.id));
