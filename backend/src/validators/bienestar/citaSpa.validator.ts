...
export const createCitaSpaSchema = z
  .object({
    terapeuta_id: z.number().int().positive("El ID del terapeuta es obligatorio"),
    servicio_spa_id: z.number().int().positive("El ID del servicio de spa es obligatorio"),
